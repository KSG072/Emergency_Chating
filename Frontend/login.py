...
class Ui_Dialog(QtWidgets.QDialog):
    ...
    def LGMessageBox(self):
        ...
        if self.ID.text() == '1234': #1234가 아닌 DB 안에 존재하는 ID 와 검사
            if self.Password.text() == '1234': #1234가 아닌 DB 안에 존재하는 Password 와 검사
                ...
                msgbox.information(self, 'MessageBox title', '비번틀림', QtWidgets.QMessageBox.Yes)
        else:
            msgbox.information(self, 'MessageBox title', 'id틀림', QtWidgets.QMessageBox.Yes)
